import { processHeaders, parseHeaders, flattenHeaders } from '../../example/helpers/headers'
...
describe('helpers::headers', () => {
    ...
    test('should parse headers', () => {
      const parsed = parseHeaders(
        'Content-Type: application/json\r\n' +
          ...
          'Date: Tue Aug 13 2019 16:13:26 GMT+0800 (中国标准时间)\r\n' +
          ':aa\r\n' +
          'key:'
      )
      ...
      expect(parsed['date']).toBe('Tue Aug 13 2019 16:13:26 GMT+0800 (中国标准时间)')
  ...
  describe('processHeaders', () => {
    ...
    test('should do nothing if data is not PlainObject', () => {
      const headers: any = {}
      processHeaders(headers, 'abc')
      expect(headers['Content-Type']).toBeUndefined()
    })
  })
  describe('flattenHeaders', () => {
    test('should flatten the headers and include common header', () => {
      const headers = {
